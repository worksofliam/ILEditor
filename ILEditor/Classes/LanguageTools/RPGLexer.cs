...
{
{ Type.BLOCK_OPEN, new[] {  "(" } },{ Type.BLOCK_CLOSE, new[] {  ")" } },{ Type.OPERATION, new[] { "BEGSR", "DCL-F", "DCL-S", "DCL-C", "DCL-PARM", "DCL-SUBF", "DCL-DS", "END-DS", "DCL-PROC", "DCL-PI", "END-PI" } },{ Type.INT_LITERAL, new[] {  "/[-0-9]+/" } },{ Type.DOUBLE_LITERAL, new[] {  @"/\d+\.?\d*/" } },{ Type.WORD_LITERAL, new[] {  "/.*?/" } },{ Type.PARMS, new[] {  ":" } },{ Type.SEPERATOR, new[] {  ";" } }
};
